...
\vspace{-0.1in}  
\section{EXPERIENCE} 
ANALYST, BASEBALL ANALYTICS \hfill Summer 2019 - Present	\\
Baltimore Orioles, Baltimore, MD

\begin{itemize}
	\item Used machine learning techniques in R and Python to help create effective metrics from player tracking data.
